...
fun printred x = print ("\027[31m"^x^"\027[0m")
fun printgreen x = print ("\027[32m"^x^"\027[0m")
fun printwhite x = print ("\027[37m"^x^"\027[0m")
fun printyellow x = print ("\027[33m"^x^"\027[0m")
fun printblue x = print ("\027[34m"^x^"\027[0m")
...
fun step (Push x)     stack           = x :: stack
  ...
  | step (Printincolor(x,c)) _        = (case c of 
                                        red => (printred x;[])
                                      |  green => (printgreen x;[])
                                      |  white => (printwhite x;[])
                                      |  yellow => (printyellow x;[])
                                      |  blue   => (printblue x;[]))
